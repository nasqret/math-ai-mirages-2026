...
const checks = [
  ...
  [html.includes("Rejewski, Tiny GPT, and research workflows are already deployed."), "concrete teaching headline is missing"],
  [html.includes("applets/uat-contradiction.html"), "UAT teaching artifact link is missing"],
  [html.includes("group_research_project.html"), "student paper-reproduction link is missing"],
